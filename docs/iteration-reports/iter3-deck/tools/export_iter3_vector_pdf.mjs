...
const outDir = process.env.ITER3_DECK_OUT || deck;
const slidePdfDir = `${outDir}/iter3-vector-slide-pdfs`;
...
const slides = [
  ...
  "11-observer-code.html",
  "12-state-impact.html",
  "13-sequence-overview.html",
  "14-seq-hold.html",
  "15-seq-payfail.html",
  "16-seq-flight.html",
  "17-seq-connecting.html",
  "18-seq-mileage.html",
